...
<div class="container mx-auto px-4 py-8">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div class="bg-white rounded-lg shadow-md p-6 mb-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                    ...
                    <div>
                        ...
                        <p class="font-semibold">{{ $order->user->name }} ({{ $order->user->email }})</p>
                    </div>
                    <div>
        ...
        <div class="lg:col-span-1">
            <div class="bg-white rounded-lg shadow-md p-6 mb-6">
                <h2 class="text-xl font-semibold mb-4">Update Status Pesanan</h2>
                ...
                <form action="{{ route('admin.orders.updateStatus', $order->id) }}" method="POST">
                    ...
                    <div class="mb-4">
                        <label for="payment_status" class="block text-gray-700 font-medium mb-2">Status Pembayaran</label>
                        <select id="payment_status" name="payment_status" class="w-full border rounded-lg px-3 py-2" required>
                    ...
                    <div class="mb-4">
                        <label for="order_status" class="block text-gray-700 font-medium mb-2">Status Pesanan</label>
                        <select id="order_status" name="order_status" class="w-full border rounded-lg px-3 py-2" required>
            ...
            <div class="bg-white rounded-lg shadow-md p-6">
                ...
                <a href="{{ route('admin.orders.index') }}" class="w-full bg-gray-200 text-gray-800 py-3 rounded-lg font-semibold hover:bg-gray-300 transition text-center block">
                    Kembali ke Daftar
                </a>
            </div>
        </div>
